...
export default defineConfig({
  ...
  layout: {
    ...
    siderWidth: 208,
    ...defaultSettings,
    logo: (publicPath ?? basePath) + 'logo.svg',
  },
  /**
  ...
  headScripts: [
    // 解决首次加载时白屏的问题
    { src: join(publicPath, 'scripts/loading.js'), async: true },
  ],
  //================ pro 插件配置 =================
  // presets: ['umi-presets-pro'],
  presets: ['./src/presets/umi-presets-pro'],
  /**
   * @name openAPI 插件的配置
  ...
  openAPI: [
    {
      ...
      schemaPath: join(__dirname, 'fuck-web.json'),
      mock: false,
      projectName: 'fuck-web',
    },
  ],
  mfsu: {
    strategy: 'normal',
