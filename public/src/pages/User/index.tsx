...
import { getSessions as getUserSessions, deleteSession } from '@/services/fuck-web/sessions';
import {
...
const UserList: React.FC = () => {
  ...
  const columns: ProColumns<API.UserInfo>[] = [
    ...
    {
      title: intl.t('title.option', 'Operating'),
      dataIndex: 'option',
      valueType: 'option',
      render: (_, record) => {
        return [
