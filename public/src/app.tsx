...
import { getGlobalConfig } from '@/services/fuck-web/global';
import { currentUser as queryCurrentUser } from '@/services/fuck-web/user';
...
export const layout: RunTimeLayoutConfig = ({ initialState, setInitialState }) => {
  ...
  return {
    actionsRender: () => [
      ...
      ...getActions(initialState?.currentUser?.role),
    ],
