...
.PHONY: all
all: common-check_license protos common-lint test fuck-web
...
docker-image:
	...
	cd docker && docker build -t microops-cn/fuck-web:v$(Version).$(GitCommit)$(IMAGE_SUFFIX) .