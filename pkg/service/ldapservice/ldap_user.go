...
//	@return dn  string
//	@return err error
func (s UserService) getUserDnByEntryUUID(ctx context.Context, id string) (dn string, err error) {
...
//	@return err          error
func (s UserService) getUserObjectClass(ctx context.Context, dn string) (objectClass sets.Set[string], err error) {
	conn := s.Session(ctx)
	defer conn.Close()
...
//	@return dns       []string
//	@return err       error
func (s UserService) getDNSByReq(ctx context.Context, searchReq *goldap.SearchRequest) (dns []string, err error) {
	conn := s.Session(ctx)
	defer conn.Close()
...
//	@return err        error
func (s UserService) getUserByReq(ctx context.Context, searchReq *goldap.SearchRequest, o *opts.GetUserOptions) (*models.User, error) {
	conn := s.Session(ctx)
	defer conn.Close()
...
func (s UserService) getUserByEntry(_ context.Context, userEntry *goldap.Entry) *models.User {
...
//	@return userDetail   *models.User
//	@return err          error
func (s UserService) getUserByDn(ctx context.Context, dn string) (*models.User, error) {
	searchReq := goldap.NewSearchRequest(
...
//	@return userDetail   *models.User
//	@return err          error
func (s UserService) getUserByUsername(ctx context.Context, username string, o *opts.GetUserOptions) (*models.User, error) {
	searchReq := goldap.NewSearchRequest(
		s.Options().UserSearchBase,
...
//	@return userDetail   *models.User
//	@return err          error
func (s UserService) GetUserInfoByUsernameAndEmail(ctx context.Context, username, email string) (*models.User, error) {
	searchReq := goldap.NewSearchRequest(
		s.Options().UserSearchBase,
		goldap.ScopeSingleLevel, goldap.NeverDerefAliases, 1, 0, false,
		fmt.Sprintf("(&(%s=%s)(%s=%s))",
...
//	@param _
//	@return error
func (s UserService) UpdateLoginTime(_ context.Context, _ string) error {
	return nil
}
...
//	@return count	int64
//	@return err		error
func (s UserService) DeleteUsers(ctx context.Context, ids []string) (count int64, err error) {
	conn := s.Session(ctx)
	defer conn.Close()
	for _, id := range ids {
		var dn string
...
//	@return userDetail	*models.User
//	@return err	error
func (s UserService) GetUserInfoById(ctx context.Context, id string, o *opts.GetUserOptions) (*models.User, error) {
	conn := s.Session(ctx)
	defer conn.Close()
	searchReq := goldap.NewSearchRequest(
		s.Options().UserSearchBase,
...
//	@return err	error
func (s UserService) PatchUser(ctx context.Context, user map[string]interface{}) (err error) {
	conn := s.Session(ctx)
	defer conn.Close()
...
//	@param password 	string
//	@return users	[]*models.User
func (s UserService) VerifyPasswordById(ctx context.Context, id, password string) (user *models.User) {
	conn := s.Session(ctx)
	defer conn.Close()
	logger := log.GetContextLogger(ctx)
	searchReq := goldap.NewSearchRequest(
...
func (s UserService) GetUsersById(ctx context.Context, ids []string) (users models.Users, err error) {
	for _, id := range ids {
